...
pExp (ECond BTrue b c) = parens(pExp BTrue <+> text "?" <+> pExp b <+> text ":" <+> pExp c)
pExp (ECond BFalse b c) = parens(pExp BFalse <+> text "?" <+> pExp b <+> text ":" <+> pExp c)
pExp (ECond a b c) = parens(parens (pExp a) <+> text "?" <+> pExp b <+> text ":" <+> pExp c)
